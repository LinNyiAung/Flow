                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                              ...
                              children: [
                                _buildBalanceInfo(
                                  ...
                                  amount:
                                      ...
                                      0.0,
                                  currency:
                                      transactionProvider.balance?.currency ??
                                      authProvider.defaultCurrency,
                                  color: Colors.green,
                                ),
                                Container(
                                  height: 40,
                            ...
                            // Only show when there are transactions in currencies
                            // other than the user's default currency
                            if (transactionProvider.transactions.any(
                              (t) => t.currency != authProvider.defaultCurrency,
                            )) ...[
                              SizedBox(height: 16),
                              GestureDetector(
