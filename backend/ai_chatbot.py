...
"""
    ...
    def chat(self, user_id: str, message: str, chat_history: Optional[List[Dict]] = None) -> str:
        """Chat with user's financial data"""
        try:
            print(f"Processing chat for user {user_id}: {message[:50]}...")
            ...
            # Check if user has any transactions
            if summary.get("message"):
                return "I don't have access to your financial data yet. Please add some transactions first!"
